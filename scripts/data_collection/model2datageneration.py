...
data_path = os.path.join(path_to_data, "features-targets.csv") 
data = pd.read_csv(data_path)

# Load the optimal bids
optimal_bids_path = os.path.join(path_to_data, "optimal_bids_v2.csv")
...
data = data.merge(optimal_bids, on='ts', how='left')
...
selected_features = [
    ...
    'Kalby_AP',                     # Actual wind power production, important for revenue calculation
